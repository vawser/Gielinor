...
public sealed class BinaryReaderEx
{
    ...
    {
        return ReadCharsTerminated(ReaderEncoding.ASCII);
    }
    ...
    {
        return ReadChars(ReaderEncoding.ASCII, length);
    }
    ...
    {
        return ReadCharsTerminated(ReaderEncoding.ShiftJIS);
    }
    ...
    {
        return ReadChars(ReaderEncoding.ShiftJIS, length);
    }
    ...
    public string ReadUTF16()
    {
        ...
        if (BigEndian)
            return ReaderEncoding.UTF16BE.GetString(bytes.ToArray());
        else
            return ReaderEncoding.UTF16.GetString(bytes.ToArray());
    }
    ...
    public string ReadFixStr(int size)
    {
        ...
        return ReaderEncoding.ShiftJIS.GetString(bytes, 0, terminator);
    }
    ...
    public string ReadFixStrW(int size)
    {
        ...
        if (BigEndian)
            return ReaderEncoding.UTF16BE.GetString(bytes, 0, terminator);
        else
            return ReaderEncoding.UTF16.GetString(bytes, 0, terminator);
    }
    #endregion
