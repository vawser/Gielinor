...
public class Runebox
{
    ...
    public unsafe Runebox(IGraphicsContext context, string version)
    {
        _version = version;
    ...
    {
        Octokit.GitHubClient gitHubClient = new(new Octokit.ProductHeaderValue("Runebox"));
        Octokit.Release release = gitHubClient.Repository.Release.GetLatest("vawser", "Runebox").Result;
        var isVer = false;
        var verstring = "";
